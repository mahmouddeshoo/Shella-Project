...
function RegesterContainer() {
    return (
        <section className="register-container" aria-label="خيارات التسجيل في شلة">
            <div className="register-container-wrapper">
                <div className="register-container-gray1 first-Fadein">
                    <div className="register-container-img">
                        <img src={marketJob} alt="رمز التسجيل كمطعم أو متجر" loading="lazy" />
                    </div>
                    <div className="register-container-title">
                        <div className="register-container-title-p">
                            <h2 className="register-container-title-1">سجل مطعمك أو متجرك</h2>
                        ...
                        <div className="register-container-title-link">
                            ...
                            >
                                 <FontAwesomeIcon
                                    icon={faChevronRight}
                                    style={{ fontSize: '15px', color: '#2D3633', marginLeft: '20px', backgroundColor:'#fa9d2b', padding:'3px',borderRadius:'4px' }}
                                />
                                سجل الآن
                ...
                <div className="register-container-white2 third-Fadein">
                    <div className="register-container-img">
                        <img src={moneyBag} alt="رمز التسجيل كمستثمر في شلة" loading="lazy" />
                    </div>
                    <div className="register-container-title">
                        <div className="register-container-title-p">
                            <h2 className="register-container-title-1">سجل الآن كمستثمر في شلة</h2>
                            <p className="register-container-title-2">
