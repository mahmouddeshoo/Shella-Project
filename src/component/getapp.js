    ...
    return (
        <section className="getapp-section">
            ...
            <div className="getapp-section-links">
                <a href="/" rel="noopener noreferrer" aria-label="تحميل تطبيق App Store">
                    <img src={appStore} alt="App Store" />
                </a>
                <a href="/" rel="noopener noreferrer" aria-label="تحميل تطبيق Play Store">
                    <img src={playStore} alt="Play Store" />
                </a>
                <a href="/" rel="noopener noreferrer" aria-label="تحميل تطبيق App Gallery">
